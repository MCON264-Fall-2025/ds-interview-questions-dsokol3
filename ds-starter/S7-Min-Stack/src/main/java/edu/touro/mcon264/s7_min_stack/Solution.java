...
public class Solution {
    // TODO: Implement solution for: Min-Stack (O(1) getMin)
    ...
    public void push(int x) {
        ...
        if (minSt.isEmpty() || x <= minSt.peek()) {
            ...
            // Otherwise, push the top element of minSt again to keep the minimum unchanged
    ...
    // toString() so we can print it neatly in Main
